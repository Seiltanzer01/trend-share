...
Revision ID: 90f7a44fcc7e
Revises: 
Create Date: 2024-11-12 15:25:21.693179
...
def upgrade():
    ...
    sa.Column('setup_name', sa.String(length=100), nullable=False),
    ...
    sa.Column('trade_open_time', sa.Date(), nullable=False),
