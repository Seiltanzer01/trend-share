...
def get_balances(user: User) -> dict:
    ...
    Балансы округляются вниз до 4 знаков после запятой и возвращаются как числовые значения.
    В случае ошибки возвращаются нулевые балансы.
    """
    try:
        ...
        return {"balances": {"eth": 0, "weth": 0, "ujo": 0}}
